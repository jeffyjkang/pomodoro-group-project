...
class App extends React.Component {
  ...
  setLength = ev => {
    ...
    if (this.state.running === false) {
      ...
      alert(
        "You've gotta, like, stop the timer before you can, you know... change things, man."
      )
    }
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Pomodoro</h1>
        <TimerDisplay
          counterMins={this.state.Mins}
          counterSecs={this.state.Secs}
          breakFlag={this.state.onBreak}
        />
        <ButtonDisplay
          reset={this.reset}
        ...
        <SessionLength
          ...
          submitLength={this.submitLength}
        />
        <BreakLength
          setLength={this.setLength}
